...
export const T = {
  ...
  gra: {
    ...
    odrzucone: 'Odrzucone',
    reka: 'Twoja ręka',
    rekaPrzeciwnika: 'Ręka przeciwnika',
    zasadzki: 'Zasadzki',
    liniaBitewna: 'Linia bitewna',
    zakonczFaze: 'Zakończ fazę',
    pasuj: 'Pasuj',
    zatwierdzRozkazy: 'Zatwierdź rozkazy',
    zakonczDobieranie: 'Gotowe',
    wymien: 'Wymień zaznaczone',
    odrzucIWymien: 'Odrzuć 1 i wymień resztę',
    rozstrzygnij: 'Rozstrzygnij starcie',
    dalej: 'Dalej',
    nowaGra: 'Nowa gra',
    menu: 'Menu',
    ofensywa: 'OFN',
    ...
    czekaNaPrzeciwnika: 'Przeciwnik jeszcze gra',
    spasowal: 'spasował',
    ...
    rekaPrzeciwnikaJawna: 'Ręka przeciwnika (jawna)',
    bezRozkazu: 'czeka na rozkaz',
